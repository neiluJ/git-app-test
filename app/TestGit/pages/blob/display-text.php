<table class="blob">
    <tbody>
        <tr>
            ...
            <td class="contents code-display"><pre><code id="blobCtx"<?php if($this->language != false): ?> class="<?php echo $this->language; ?>"<?php endif; ?>><?php echo $this->_helper->escape(trim($this->blob->getContent())); ?></code></pre></td>
        </tr>
    </tbody>
</table>
