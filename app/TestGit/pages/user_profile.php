                  ...
                  <div class="panel-body">
                      <ul class="repositories">
                          ...
                          <li>
                              ...
                              <?php endif; ?>
                              <?php if($repo->getParent_id() == null): ?><i class="glyphicon glyphicon-list"></i><?php else: ?><i class="glyphicon glyphicon-retweet"></i><?php endif; ?> <?php if($repo->isPrivate()): ?><i class="glyphicon glyphicon-lock"></i><?php endif; ?> <a class="repo-name" href="<?php echo $this->_helper->url('Repository', array('name' => $repo->getFullname())); ?>"><?php echo $this->_helper->escape($repo->getName()); ?></a> <?php if($repo->getParent_id() != null): ?><span class="fork">forked from <a class="repo-name" href="<?php echo $this->_helper->url('Repository', array('name' => $repo->getParent()->getFullname())); ?>"><?php echo $this->_helper->escape($repo->getParent()->getFullname()); ?></a></span><?php endif; ?>
